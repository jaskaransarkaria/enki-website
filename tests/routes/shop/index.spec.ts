...
test("loads /shop", async ({ page }) => {
  ...
  await expect(page.locator("[data-testid=cdn-img] >> nth=0")).toHaveAttribute("srcset", "https://enki.imgix.net/1876023?auto=format,compress")
  ...
  await expect(page.locator("[data-testid=cdn-img] >> nth=3")).toHaveAttribute("srcset", "https://enki.imgix.net/faith.jpg?auto=format,compress")

  await expect(page.locator("div > h3 >> nth=4")).toHaveText("Hippopotamus")
  await expect(page.locator("[data-testid=cdn-img] >> nth=4")).toHaveAttribute("srcset", "https://enki.imgix.net/faith.jpg?auto=format,compress")
  
  await expect(page.locator("div > h3 >> nth=5")).toHaveText("Lion")
  await expect(page.locator("[data-testid=cdn-img] >> nth=5")).toHaveAttribute("srcset", "https://enki.imgix.net/faith.jpg?auto=format,compress")

  await expect(page.locator("div > h3 >> nth=6")).toHaveText("Water Buffalo")
  await expect(page.locator("[data-testid=cdn-img] >> nth=5")).toHaveAttribute("srcset", "https://enki.imgix.net/faith.jpg?auto=format,compress")
  
  await expect(page.locator("div > h3 >> nth=7")).toHaveText("Zebra")
  await expect(page.locator("[data-testid=cdn-img] >> nth=7")).toHaveAttribute("srcset", "https://enki.imgix.net/faith.jpg?auto=format,compress")
