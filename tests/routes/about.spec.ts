...
test("About Page", async ({ page }) => {
  ...
  await expect(page.locator(".shop-pics > img >> nth=0")).toHaveAttribute("src", "https://enki.imgix.net/left_enki.jpg?auto=format,compress&q=1");
  await expect(page.locator(".shop-pics > img >> nth=1")).toHaveAttribute("src", "https://enki.imgix.net/about_shop_1.jpg?auto=format,compress&q=1");
  await expect(page.locator(".shop-pics > img >> nth=2")).toHaveAttribute("src", "https://enki.imgix.net/right_enki.png?auto=format,compress&q=1");
