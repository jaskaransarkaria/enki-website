...
test("About Page", async ({ page }) => {
  ...
  await expect(page.locator(".card > p >> nth=1")).toHaveText(
    "Dora joined Enki in 2018 and has been learning jewellery making ever since, she’s always been a crafter and can do amazing things with beads! She comes from Germany but has been in Brum for the last six years. You can find her at Enki Wednesday to Saturday and every other Sunday."
  );
  await expect(page.locator(".card > p >> nth=2")).toHaveText(
    "Ash Joined Enki in 2021, he’s a web developer who dabbles in photography among other things!"
  );
});
