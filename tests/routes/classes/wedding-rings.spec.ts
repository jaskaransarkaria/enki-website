...
test("Classes Wedding Ring Page", async ({ page }) => {
  ...
  await expect(page.locator(".class-pics > img >> nth=0")).toHaveAttribute(
    "src",
    "https://enki.imgix.net/wedding_bands_1.jpg?auto=compress"
  );
  await expect(page.locator(".class-pics > img >> nth=1")).toHaveAttribute(
    "src",
    "https://enki.imgix.net/wedding_bands_2.jpg?auto=compress"
  );
  await expect(page.locator(".class-pics > img >> nth=2")).toHaveAttribute(
    "src",
    "https://enki.imgix.net/wedding_bands_3.jpg?auto=compress"
  );

  await expect(page.locator("h1")).toHaveText(
    "Make your partner the most important piece of jewellery they’ll ever own"
  );
  await expect(page.locator(".container > p >> nth=0"))
    .toHaveText(`In this private class for you and your partner, you will make each other a
